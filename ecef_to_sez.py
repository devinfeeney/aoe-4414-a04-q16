...
# Parameters:
#  o_x_km: x component of ECEF vector, with origin of the SEZ frame
#  o_y_km: y component of ECEF vector, with origin of the SEZ frame
#  o_z_km: z component of ECEF vector, with origin of the SEZ frame
